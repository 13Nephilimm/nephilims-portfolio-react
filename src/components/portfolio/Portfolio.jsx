...
const data = [
  {
    ...
    title: "Joblist",
    description:
      "Biggest job listing website in Georgia! built with Vue JS & Laravel API",
    github: "https://github.com/13Nephilimm/joblist",
    demo: "https://joblist.ge",
  },
  {
    id: 2,
    image: IMG1,
    title: "Simple Steps",
    description:
      "Simple Steps - Marketing company official website with React JS",
